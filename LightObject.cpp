...
void LightObject::initShader() {
    m_shader = std::make_unique<Shader>( "shaders/light_object_vertex_shader.glsl", "shaders/light_object_fragment_shader.glsl" );
}

void LightObject::draw(const glm::mat4& model, const glm::mat4& view, const glm::mat4& projection) {   
    m_shader->useProgram();
...
void LightObject::setMVP(const glm::mat4& model, const glm::mat4& view, const glm::mat4& projection) {
    glm::mat4 grandStarModel = glm::translate(glm::mat4(1.0f), m_light.m_position);
